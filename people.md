...
{% if pi_members.size > 0 %}
  <h2 class="section-subhead" id="pi">Principal Investigator</h2>
...
{% if staff_members.size > 0 %}
  <h2 class="section-subhead" id="staff">Research Staff</h2>
  <div class="grid grid--3">
...
{% if collab_members.size > 0 %}
  <h2 class="section-subhead" id="collaborators">Collaborators</h2>
  <div class="grid grid--3">
...
{% if grad_members.size > 0 %}
  <h2 class="section-subhead" id="grad">Graduate Students</h2>
  <div class="grid grid--3">
...
{% if undergrad_members.size > 0 %}
  <h2 class="section-subhead" id="undergrad">Undergraduate Researchers</h2>
  <div class="grid grid--3">
...
{% if intern_members.size > 0 %}
  <h2 class="section-subhead" id="intern">Visiting Interns</h2>
  <div class="grid grid--3">
...
{% if alumni_members.size > 0 %}
  <h2 class="section-subhead" id="alumni">Lab Alumni</h2>
  <div class="grid grid--3">
